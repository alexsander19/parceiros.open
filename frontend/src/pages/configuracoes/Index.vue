<template>
  <div>
    <q-list class="text-weight-medium">
      ...
      >
        <q-item-section>
          <q-item-label>Forçar atendimento via Equipe</q-item-label>
          <q-item-label caption>Caso o contato tenha equipe vínculada, o sistema irá direcionar o atendimento somente para os donos da equipe de clientes.</q-item-label>
        </q-item-section>
        <q-item-section avatar>
          <q-toggle
